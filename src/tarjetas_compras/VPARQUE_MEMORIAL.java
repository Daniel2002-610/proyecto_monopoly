 ...
 * @author edgar
 */
public class VPARQUE_MEMORIAL extends javax.swing.JFrame {

    PARQUE_MEMORIAL vdat = new PARQUE_MEMORIAL();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/recursos/MEMORIAL_1.png"))); // NOI18N
 ...
 //metodo comprar
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VPARQUE_MEMORIAL.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VPARQUE_MEMORIAL().setVisible(true);
            }
        });
    }
