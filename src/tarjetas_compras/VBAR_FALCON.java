 ...
 * @author edgar
 */
public class VBAR_FALCON extends javax.swing.JFrame {
       BAR_FALCON  vdat = new BAR_FALCON();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/recursos/FALCON_1.png"))); // NOI18N
...
if ("".equals(vdat.dueño)) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VBAR_FALCON.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VBAR_FALCON().setVisible(true);
            }
        });
    }
