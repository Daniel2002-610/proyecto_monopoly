 ...
 * @author edgar
 */
public class VBIBLIOTECA_PUBLICA extends javax.swing.JFrame {
   BIBLIOTECA_PUBLICA vdat = new BIBLIOTECA_PUBLICA();
   ...
   tablero tab = new tablero();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/recursos/BIBLIOTECA_1.png"))); // NOI18N
 ...
 //metodo comprar
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VBIBLIOTECA_PUBLICA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VBIBLIOTECA_PUBLICA().setVisible(true);
            }
        });
    }
