 ...
 * @author edgar
 */
public class VCASA_NEIBOLT extends javax.swing.JFrame {
    CASA_NEIBOLT vdat = new CASA_NEIBOLT();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/recursos/NEIBOLT_1.png"))); // NOI18N
...
if ("".equals(vdat.dueño)) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VCASA_NEIBOLT.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VCASA_NEIBOLT().setVisible(true);
            }
        });
    }
