 ...
 * @author edgar
 */
public class VRESTAURANTE_JADE extends javax.swing.JFrame {

    RESTAURANTE_JADE vdat = new RESTAURANTE_JADE();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/recursos/JADE_1.png"))); // NOI18N
...
if ("".equals(vdat.dueño)) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VRESTAURANTE_JADE.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VRESTAURANTE_JADE().setVisible(true);
            }
        });
    }
