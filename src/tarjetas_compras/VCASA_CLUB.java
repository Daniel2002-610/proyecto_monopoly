...
public class VCASA_CLUB extends javax.swing.JFrame {

    CASA_CLUB vdat = new CASA_CLUB();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/recursos/CLUB_1.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VCASA_CLUB.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VCASA_CLUB().setVisible(true);
            }
        });
    }
