 ...
 * @author edgar
 */
public class VCASA_DE_LA_RISA extends javax.swing.JFrame {

   CASA_DE_LA_RISA vdat = new CASA_DE_LA_RISA();
   tablero tab = new tablero();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/recursos/RISA_1.png"))); // NOI18N
 ...
 //metodo comprar
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VCASA_DE_LA_RISA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VCASA_DE_LA_RISA().setVisible(true);
            }
        });
    }
