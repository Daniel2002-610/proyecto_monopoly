 ...
 * @author edgar
 */
public class VTEATRO_ALADDIN extends javax.swing.JFrame {

    TEATRO_ALADDIN vdat = new TEATRO_ALADDIN();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/recursos/ALADDIN_1.png"))); // NOI18N
...
if ("".equals(vdat.dueño)) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VTEATRO_ALADDIN.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VTEATRO_ALADDIN().setVisible(true);
            }
        });
    }
