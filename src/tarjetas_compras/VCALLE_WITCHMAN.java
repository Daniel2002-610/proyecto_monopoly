 ...
 * @author edgar
 */
public class VCALLE_WITCHMAN extends javax.swing.JFrame {

    CALLE_WITCHMAN vdat = new CALLE_WITCHMAN();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/recursos/WITCHMAN_1.png"))); // NOI18N
...
if (tab.cont == 1) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VCALLE_WITCHMAN.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VCALLE_WITCHMAN().setVisible(true);
            }
        });
    }
