...
public class VLA_CASA_ANTIGUA extends javax.swing.JFrame {
    ...
    /**
     * Creates new form LA_CASA_ANTIGUA
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/recursos/ANTIGUA_1.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VLA_CASA_ANTIGUA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VLA_CASA_ANTIGUA().setVisible(true);
            }
        });
    }
