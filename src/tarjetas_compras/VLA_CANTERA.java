 ...
 * @author edgar
 */
public class VLA_CANTERA extends javax.swing.JFrame {
     LA_CANTERA vdat = new LA_CANTERA();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/recursos/CANTERA_1.png"))); // NOI18N
...
if ("".equals(vdat.dueño)) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VLA_CANTERA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VLA_CANTERA().setVisible(true);
            }
        });
    }
