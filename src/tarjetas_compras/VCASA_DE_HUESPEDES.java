 ...
 * @author edgar
 */
public class VCASA_DE_HUESPEDES extends javax.swing.JFrame {

   CASA_DE_HUESPEDES vdat = new CASA_DE_HUESPEDES();
   tablero tab = new tablero();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/recursos/HUESPEDES_1.png"))); // NOI18N
...
if ("".equals(vdat.dueño)) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VCASA_DE_HUESPEDES.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VCASA_DE_HUESPEDES().setVisible(true);
            }
        });
    }
