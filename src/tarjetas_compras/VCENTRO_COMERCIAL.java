 ...
 * @author edgar
 */
public class VCENTRO_COMERCIAL extends javax.swing.JFrame {

    CENTRO_COMERCIAL vdat = new CENTRO_COMERCIAL();
 ...
 jpanel jpanel = new jpanel();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/recursos/COMERCIAL_1.png"))); // NOI18N
  ...
  //metodo comprar
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VCENTRO_COMERCIAL.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VCENTRO_COMERCIAL().setVisible(true);
            }
        });
    }
