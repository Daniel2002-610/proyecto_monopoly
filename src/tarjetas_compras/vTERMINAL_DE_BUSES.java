...
public class vTERMINAL_DE_BUSES extends javax.swing.JFrame {

    TERMINAL_DE_BUSES vdat = new TERMINAL_DE_BUSES();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/recursos/BUSES.png"))); // NOI18N
 ...
 if ("".equals(vdat.dueño)) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vTERMINAL_DE_BUSES.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new vTERMINAL_DE_BUSES().setVisible(true);
            }
        });
    }
