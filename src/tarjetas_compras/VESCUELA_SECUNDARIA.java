...
public class VESCUELA_SECUNDARIA extends javax.swing.JFrame {

   ESCUELA_SECUNDARIA vdat =new ESCUELA_SECUNDARIA();
   tablero tab = new tablero();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/recursos/SECUNDARIA_1.png"))); // NOI18N
...
if ("".equals(vdat.dueño)) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VESCUELA_SECUNDARIA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VESCUELA_SECUNDARIA().setVisible(true);
            }
        });
    }
