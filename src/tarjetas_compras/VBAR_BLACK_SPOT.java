 ...
 * @author edgar
 */
public class VBAR_BLACK_SPOT extends javax.swing.JFrame {
    BAR_BLACK_SPOT vdat = new BAR_BLACK_SPOT(); 
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/recursos/BLACKS_1.png"))); // NOI18N
 ...
 //metodo comprar
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VBAR_BLACK_SPOT.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VBAR_BLACK_SPOT().setVisible(true);
            }
        });
    }
