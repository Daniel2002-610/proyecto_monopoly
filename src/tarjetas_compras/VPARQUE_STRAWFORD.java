 ...
 * @author edgar
 */
public class VPARQUE_STRAWFORD extends javax.swing.JFrame {

    PARQUE_STRAWFORD vdat = new PARQUE_STRAWFORD();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/recursos/STRAWFORD_1.png"))); // NOI18N
...
if ("".equals(vdat.dueño)) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VPARQUE_STRAWFORD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VPARQUE_STRAWFORD().setVisible(true);
            }
        });
    }
