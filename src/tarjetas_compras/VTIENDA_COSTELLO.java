 ...
 * @author edgar
 */
public class VTIENDA_COSTELLO extends javax.swing.JFrame {

    TIENDA_COSTELLO vdat = new TIENDA_COSTELLO();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/recursos/COSTELLO_1.png"))); // NOI18N
...
if ("".equals(vdat.dueño)) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VTIENDA_COSTELLO.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VTIENDA_COSTELLO().setVisible(true);
            }
        });
    }
