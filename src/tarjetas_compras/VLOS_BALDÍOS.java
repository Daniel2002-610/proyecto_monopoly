 ...
 * @author edgar
 */
public class VLOS_BALDÍOS extends javax.swing.JFrame {
    LOS_BALDIOS vdat = new LOS_BALDIOS();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/recursos/BALDIOS_1.png"))); // NOI18N
...
if ("".equals(vdat.dueño)) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VLOS_BALDÍOS.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VLOS_BALDÍOS().setVisible(true);
            }
        });
    }
